...
export const PATCH = route(async (ctx, req, params) => mcpAdminAction(ctx, "project", "members", params.id!, await body(req, schema)), { rateLimit: "write", capability: "settings:manage" });
