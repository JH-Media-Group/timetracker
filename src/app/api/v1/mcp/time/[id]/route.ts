...
import { mcpTimeDelete, mcpTimeEdit } from "@/server/services/mcp-actions";
...
export const DELETE = route<unknown>(async (ctx, _req, params) => mcpTimeDelete(ctx, params.id!), { rateLimit: "write" });
