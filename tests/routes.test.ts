...
const EXEMPT: Record<string, string> = {
  ...
  "users/[id]/rates":
    ...
    "POST and PUT declare rates:manage, and the service additionally requires " +
    "rates:view_cost to write a cost rate, refuses anybody outside the actor's " +
    "reach with a 404, and refuses setting your own rate unless you are the owner. " +
    "(This line said rates:view_cost until a review compared it to the code; the " +
    "behaviour was right and the sentence meant to make it checkable was not.)",
  "users/[id]/rates/[rateId]":
